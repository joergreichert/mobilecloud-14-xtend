...
public class VideoSvc implements VideoSvcApi {
	...
	@ResponseBody override addVideo(@RequestBody Video v){
		videos.addVideo(v)
	}
	...
	@ResponseBody override getVideoList(){
		videos.videos
	}
	...
	@ResponseBody override Collection<Video> findByTitle(
