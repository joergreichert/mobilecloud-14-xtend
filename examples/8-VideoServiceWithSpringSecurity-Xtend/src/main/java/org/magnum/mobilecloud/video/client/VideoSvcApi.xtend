...
public interface VideoSvcApi {
	...
	@FormUrlEncoded
	@POST(LOGIN_PATH)
	public def Void login(@Field(USERNAME_PARAMETER) String username, @Field(PASSWORD_PARAMETER) String pass)
	
	@GET(LOGOUT_PATH)
	public def Void logout()
	
	@GET(VIDEO_SVC_PATH)
	public def Collection<Video> getVideoList()
	
	@POST(VIDEO_SVC_PATH)
	public def Void addVideo(@Body Video v)
	...
	public def Collection<Video> findByDurationLessThan(@Query(DURATION_PARAMETER) String title)
